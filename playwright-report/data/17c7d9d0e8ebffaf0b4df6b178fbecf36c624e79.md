  ...
  - main [ref=e17]:
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e25]:
        ...
        - paragraph [ref=e27]: Drag baggage options here
      - generic [ref=e28]:
        - paragraph [ref=e29]: "Available options (drag to add):"
        - generic [ref=e30]: Carry-on (1 piece) – 7 kg
        - generic [ref=e31]: Checked bag (1 piece) – 23 kg
        - generic [ref=e32]: Checked bag (2 pieces) – 23 kg each
      - generic [ref=e33]:
        - button "Back" [ref=e34] [cursor=pointer]
        - button "Continue to review" [ref=e35] [cursor=pointer]
```